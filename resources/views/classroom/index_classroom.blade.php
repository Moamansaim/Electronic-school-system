                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h4 class="mb-0 font-weight-bold text-dark">
                            <i class="fas fa-door-open text-primary mr-2"></i> الصفوف الدراسية
                        </h4>
                    </div>
                    <div class="col-md-8 text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <form action="{{ route('classrooms.index') }}" method="GET" class="mr-3">
                                <div class="input-group border rounded-pill px-2 py-1 bg-light">
                                    <input type="text" name="search" class="form-control bg-transparent border-0"
                                        placeholder="ابحث عن صف أو مرحلة..." value="{{ request('search') }}"
                                        style="width: 200px;">
                            ...
                            <a href="{{ route('classrooms.create') }}" class="btn btn-primary shadow-sm px-4 rounded-pill">
                                <i class="fas fa-plus mr-1"></i> إضافة صف جديد
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="border-0 text-muted py-3"> مربي الصف </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="font-weight-bold text-dark">{{ $classroom->name }}</span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge badge-pill badge-light border px-3 py-2 text-primary">
                                            {{ $classroom->teacher->full_name ?? 'لا يوجد مربي فصل حالياً' }}
                                        </span>
                                    </td>
                                    <td>
                                        <small class="text-muted">
                                            <i class="far fa-clock mr-1"></i> {{ $classroom->created_at }}
                                        </small>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="py-5 text-center">
                                        ...
                                        <p class="text-muted">لم يتم العثور على أي صفوف دراسية حالياً.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>

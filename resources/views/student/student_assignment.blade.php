...
@section('title', ' تسجيل الطالب في مرحلة دراسية')
@section('content')
    <div class="p-4">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 15px; overflow: hidden;">
            <div class="card-header bg-white border-bottom py-3">
                <h5 class="mb-0 text-primary font-weight-bold">
                    <i class="fas fa-link mr-2"></i> تسجيل الطالب في مرحلة دراسية   
                </h5>
            </div>

            <form action="{{ route('students.storeAssignment') }}" method="POST">
                @csrf
                <div class="card-body p-5">
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <label class="form-label font-weight-bold">اسم الطالب</label>
                            <input type="text" class="form-control bg-light" readonly
                                value="{{ $student->first_name . ' ' . $student->father_name . ' ' . $student->family_name }}">

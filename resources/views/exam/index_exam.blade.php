...
@section('content')
                    ...
                    <table class="table  table-hover  align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="border-0 text-muted py-3 ">الإختبار</th>
                                <th class="border-0 text-muted py-3 ">مدة الإختبار </th>
                                <th class="border-0 text-muted py-3 ">نوع الإختبار </th>
                                <th class="border-0 text-muted py-3 ">الشهر </th>
                                <th class="border-0 text-muted py-3 ">العلامة الكلية</th>
                                <th class="border-0 text-muted py-3 ">المعلم المسؤول</th>
                                <th class="border-0 text-muted py-3 "> تاريخ الإنشاء</th>
                        ...
                        <tbody>
                            @forelse ($exams as $exam)
                                <tr>
                                    ...
                                    <td class=" text-muted">
                                        <small><i class="far fa-calendar-alt ml-1"></i>
                                            {{ $exam->updated_at }}</small>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-center" style="gap: 3px;">
                                            <a href="{{ route('exams.edit', $exam->id) }}"
                                                class="btn  btn-info mr-2 d-flex align-items-center" title="تعديل">
                                            ...
                                            <a href="{{ route('exam.questions', $exam->id) }}"
                                                ...
                                                title="عرض الأسئلة">
                                                <i class="fas fa-eye ml-1"></i> <span>عرض الأسئلة</span>
                                            </a>
                                            <a href="{{ route('exams.show', $exam->id) }}"
                                                class="btn btn-sm btn-dark mr-2 d-flex align-items-center"
                                                title="إضافة أسئلة للإختبار">
                                                <i class="fas fa-plus-circle ml-1"></i> <span>إضافة أسئلة</span>
                                            </a>
                                            <button class="btn  btn-danger d-flex align-items-center" data-toggle="modal"
                                                data-target="#deleteModal{{ $exam->id }}" title="حذف">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content border-0 shadow" style="border-radius: 15px;">
                                                    <div class="modal-body p-5 ">
                                                        ...
                                                        <p class="text-muted">هل أنت متأكد من حذف إختبار
                                                            <strong>({{ $exam->subject->name }})</strong>؟<br>
                                                        </p>
    ...
    <style>
        ...
        /* تعديل حجم الأزرار في الجدول لتكون بحجم متوسط ومريح */
        .table td .btn {
            padding: 0.5rem 0.8rem !important;
            /* قيمة متوازنة (ليست كبيرة وليست صغيرة) */
            ...
            /* لضمان محاذاة الأيقونة والنص */
            align-items: center;
            justify-content: center;
        }

        /* تعديل حجم الأيقونة لتتناسب مع النص المتوسط */
        .table td .btn i {
            font-size: 0.85rem !important;
            /* الأيقونة بنفس حجم الخط تقريباً */
            margin-left: 6px !important;
            /* مسافة بسيطة بين الأيقونة والنص */
        }

        /* المسافة بين الأزرار في الصف الواحد */
        .table td .d-flex {
            gap: 8px !important;
            /* مسافة متوسطة مريحة بين الأزرار */
        }

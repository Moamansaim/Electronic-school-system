                ...
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <h4 class="mb-0 font-weight-bold text-dark">
                            <i class="fas fa-chalkboard-student text-primary mr-2"></i> قائمة الطلاب
                        </h4>
                    </div>
                    <div class="col-md-8 text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <form action="{{ route('students.index') }}" method="GET" class="mr-3">
                            ...
                            <a href="{{ route('students.create') }}" class="btn btn-primary shadow-sm px-4 rounded-pill">
                                <i class="fas fa-plus mr-1"></i> إضافة طالب جديد
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover align-middle mb-0 min-w-full ">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="border-0 text-muted py-3">الطالب</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-soft-secondary px-2 py-2 d-inline-flex align-items-center"
                                            ...
                                            <span class="font-weight-bold ml-2">{{ $student->national_id }}</span>
                                        </span>
                                    </td>
                                    <td>
                                        <div class="small">
                                    ...
                                    <td>
                                        @if ($student->phones && $student->phones->count() > 0)

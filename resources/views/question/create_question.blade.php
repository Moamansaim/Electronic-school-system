    ...
    <div class="p-4">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 15px; overflow: hidden;">
            <div class="card-header bg-white border-bottom py-3">
                ...
                <p class="text-muted small mb-0 mt-1">أنت الآن تضيف أسئلة للاختبار الخاص بـ: <strong>{{ $exam->name }}</strong></p>
            </div>
            ...
            <form action="{{ route('questions.store') }}" method="POST" id="question_form">
                ...
                <div class="card-body p-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="question_text" maxlength="300" value="{{ old('question_text') }}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <select name="question_type" id="question_type" class="form-control border-left-0 @error('question_type') is-invalid @enderror">
                                    <option value="essay_question" {{ old('question_type') == 'essay_question' ? 'selected' : '' }}>سؤال مقالي (Essay)</option>
                        ...
                        {{-- درجة السؤال --}}
                        <div class="col-md-6 mb-4">
                            <label class="form-label font-weight-bold mb-2">درجة السؤال (Mark)</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-light border-right-0">
                                ...
                                <input type="number" name="mark" value="{{ old('mark') }}"
                                    class="form-control border-left-0 @error('mark') is-invalid @enderror" >
                            </div>
                            @error('mark')
                                <small class="text-danger mt-1 d-block">{{ $message }}</small>
                            @enderror
                            ...
                            <div class="card-body bg-light">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-group shadow-sm">
                                            ...
                                            <input type="text" name="options[]" class="form-control border-left-0" 
                                                placeholder="نص الخيار {{ $i }}" value="{{ old('options.' . ($i-1)) }}">
                                        </div>
                                    </div>
                                    @endfor
                                </div>
                                <div class="mt-2">
                                    <small class="text-muted">
                                        ...
                                        ملاحظة: اكتب نص الخيارات في الحقول أعلاه، وقم بتحديد الدائرة بجانب الخيار الذي يمثل الإجابة الصحيحة.
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-white border-0 px-0 d-flex justify-content-between align-items-center mt-4">
        ...
        <script>
            $(document).ready(function () {
                function handleQuestionTypeChange() {
                    let selectedType = $('#question_type').val();
                    let $optionsWrapper = $('#options_wrapper');
                    let $optionInputs = $('input[name="options[]"]');
